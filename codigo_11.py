...
def procesar_inventario():
    ...
    for i in range(len(productos)):
        ...
        if stock_actual > cantidad_pedida: #Si el stock ej:15 es menor a lo que pide el usuario se ejecuta, este bug causa una contradicción a la lógica del código la cual es: SI EL STOCK EJ:15 ES MAYOR a lo que pide el usuario se hace la operación
